...
public sealed class StartDispatchToPickupCommandHandler(
    IDeliveryRepository repository,
    TimeProvider timeProvider)
{
    public async Task HandleAsync(StartDispatchToPickupCommand command, CancellationToken cancellationToken = default)
    {
        ...
        delivery.StartDispatchToPickup(timeProvider.GetUtcNow());
